...
namespace IntegratedSystems.Web.Controllers
{
    public class PatientsController : Controller
    {
       ...
       private readonly IVaccinationCenterService _vaccinationCenterService;
        ...
        public PatientsController(IPatientService patientService, IVaccinationCenterService vaccinationCenterService)
        {
        ...
        {
            return _patientService.GetPatientId(id) != null;
        }
    }
}
